...
interface Draggable {
  dragStatHandler(event: DragEvent): void;
...
function validator(validatableInput: Validatable) {
  let isValid = true;
  ...
  implements Draggable
{
  ...
  configure() {
    this.element.addEventListener('dragstart', this.dragStatHandler);
...
class ProjectInput extends Component<HTMLDivElement, HTMLFormElement> {
  ...
  private gatherUserInput(): [string, string, number] | void {
    ...
    if (
      ...
      !validator(DesctiptionValidatable) ||
...
const finiscedPrjList = new ProjectList('finished');
